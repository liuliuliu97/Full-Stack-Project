...
SECRET_KEY = 'django-insecure-%@y(m76r%t7*1!nq-+)d9pft@u_=66)$h393#r)w)z_!c2xp+@'
...
# add for each application: api, 
# add all packages: rest_framework, corsheaders
INSTALLED_APPS = [
...
# specify which website is allowed to access the api
